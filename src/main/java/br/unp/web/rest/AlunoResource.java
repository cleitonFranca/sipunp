...
public class AlunoResource {
    ...
    @Timed
    public ResponseEntity<List<Aluno>> searchAlunos(@RequestParam String query, @ApiParam Pageable pageable) {
        log.debug("REST request to search for a page of Alunos for query {}", query);
        Page<Aluno> page = alunoSearchRepository.search(queryStringQuery(query), pageable);
