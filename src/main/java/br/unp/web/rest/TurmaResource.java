...
import br.unp.repository.TurmaRepository;
import br.unp.repository.search.TurmaSearchRepository;
...
public class TurmaResource {
    ...
    public TurmaResource(TurmaRepository turmaRepository, TurmaSearchRepository turmaSearchRepository) {
    ...
    public ResponseEntity<Turma> createTurma(@Valid @RequestBody Turma turma) throws URISyntaxException {
        ...
        turmaSearchRepository.save(result);
    ...
    /**
     * SEARCH  /_search/turmas?query=:query : search for the turma corresponding
     * to the query.
     *
    ...
    @Timed
    public List<Turma> searchTurmas(@RequestParam String query) {
        log.debug("REST request to search Turmas for query {}", query);
        return StreamSupport
            .stream(turmaSearchRepository.search(queryStringQuery(query)).spliterator(), false)
