...
public class CursoResourceIntTest {
    ...
    private static final String DEFAULT_COORDENADO = "AAAAAAAAAA";
    private static final String UPDATED_COORDENADO = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        CursoResource cursoResource = new CursoResource(cursoRepository, cursoSearchRepository);
    ...
    public void createCurso() throws Exception {
        ...
        assertThat(testCurso.getCoordenado()).isEqualTo(DEFAULT_COORDENADO);

        // Validate the Curso in Elasticsearch
        Curso cursoEs = cursoSearchRepository.findOne(testCurso.getId());
        assertThat(cursoEs).isEqualToComparingFieldByField(testCurso);
    }
    ...
    @Test
    @Transactional
    public void checkCoordenadoIsRequired() throws Exception {
        int databaseSizeBeforeTest = cursoRepository.findAll().size();
        // set the field null
        curso.setCoordenado(null);
    ...
    public void getAllCursos() throws Exception {
        ...
        restCursoMockMvc.perform(get("/api/cursos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].coordenado").value(hasItem(DEFAULT_COORDENADO.toString())));
    }
    ...
    public void getCurso() throws Exception {
        ...
        restCursoMockMvc.perform(get("/api/cursos/{id}", curso.getId()))
            ...
            .andExpect(jsonPath("$.coordenado").value(DEFAULT_COORDENADO.toString()));
    }
    ...
    public void updateCurso() throws Exception {
        ...
        assertThat(testCurso.getCoordenado()).isEqualTo(UPDATED_COORDENADO);
    ...
    public void deleteCurso() throws Exception {
        ...
        boolean cursoExistsInEs = cursoSearchRepository.exists(curso.getId());
        assertThat(cursoExistsInEs).isFalse();
